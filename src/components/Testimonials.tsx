  ...
  return (
    <section ref={elementRef} className="py-16">
      <div className="max-w-6xl mx-auto px-4">
        <h2
          className={`font-perfectly-nineties font-[570] text-black text-[41px] leading-none tracking-[-0.96px] text-center mb-14 max-md:text-3xl max-md:mb-10 transition-all duration-600 ease-out ${
